...
vlog -vlog01compat -work work register_1bit.v
...
vlog -vlog01compat -work work Sequential_1.v
vlog -vlog01compat -work work Sequential_2.v
vlog -vlog01compat -work work Sequential_3.v
vlog -vlog01compat -work work Sequential_4.v
vlog -vlog01compat -work work Counter.v
vlog -vlog01compat -work work register_8bit_special.v
